...
class CalendarCreateInput(BaseModel):
    ...
    user_email: str = Field(description="email of the user")
    guest_email: str = Field(description="Guests present in invite")
    calendar_id: str = Field(description="calendar id of the calendar")
...
class CreateCalendarEventTool(BaseTool):
    ...
    description = """
Useful when you want to create a calendar event given a calendar id, guests email, event name, start time, and end time.
"""
    ...
    def _run(
        ...
        events_response = create_event(
            user_email,guest_email, calendar_id, event_name, start_datetime, end_datetime
        )
        return events_response
