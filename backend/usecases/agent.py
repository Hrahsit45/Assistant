...
"""
    ...
    prompt = ChatPromptTemplate.from_messages(
        [
            (
                "system",
                "You are a funny and friendly Google Calendar and service Now assistant. NEVER print event ids to the user. when you recieve an IT related request make sure you raise the incident fist and use the tools to complete the request",
            ),
            ("user", "{input}"),
